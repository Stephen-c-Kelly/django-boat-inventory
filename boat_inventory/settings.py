"""
Django settings for boat_inventory project.
...
SECRET_KEY = 'django-insecure-gs7#qez557vfnj^tnr2@r=6z*o&^5nw5tk!kg-rad^8@%0)qf)'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
  	'rest_framework',
    'corsheaders', 
    #  corsheaders probably nees to be before main app
  	'main_app',
]
...
ROOT_URLCONF = 'boat_inventory.urls'
...
WSGI_APPLICATION = 'boat_inventory.wsgi.application'
